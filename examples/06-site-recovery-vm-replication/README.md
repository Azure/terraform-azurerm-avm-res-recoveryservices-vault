...
Description: VM SKU for source VMs used in the Site Recovery example. Defaults to Standard\_D2s\_v5 (Intel) instead of the Standard\_D2as\_v5 (AMD) family, which repeatedly hits SkuNotAvailable capacity restrictions in the pinned test zone.
