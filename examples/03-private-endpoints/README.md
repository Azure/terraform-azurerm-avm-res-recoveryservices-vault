...
This example deploys a Recovery Services Vault with private connectivity for Azure Backup and Azure Site Recovery.

## What this example shows

- Creating private endpoints for vault subresources
- Associating private DNS zones for Backup, Site Recovery, blob, and queue traffic
- Using managed identities together with private network access patterns
- A private-network design suitable for environments that restrict public access paths
...
- [azapi_resource.no_internet](https://registry.terraform.io/providers/Azure/azapi/latest/docs/resources/resource) (resource)
- [azapi_resource.nsg](https://registry.terraform.io/providers/Azure/azapi/latest/docs/resources/resource) (resource)
- [azapi_resource.private](https://registry.terraform.io/providers/Azure/azapi/latest/docs/resources/resource) (resource)
- [azapi_resource.private_links](https://registry.terraform.io/providers/Azure/azapi/latest/docs/resources/resource) (resource)
